...
{
    [DbContext(typeof(ElsaServiceDbContext))]
    [Migration("20230615101304_Add_Absences")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MERP.ElsaService.Entities.Absences.Absence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppAbsences", (string)null);
                });

            modelBuilder.Entity("MERP.ElsaService.Entities.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MERP.ElsaService.Entities.LeaveBalances.LeaveBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MERP.ElsaService.Entities.Leaves.Leave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MERP.ElsaService.Entities.Absences.Absence", b =>
                {
                    b.HasOne("MERP.ElsaService.Entities.Employees.Employee", "Employee")
                        .WithMany()
